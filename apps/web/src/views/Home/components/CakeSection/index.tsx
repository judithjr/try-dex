    ...
    >
      <Text textAlign="center" padding="0px 16px">
        ...
        <Text
          ...
          display="inline"
          marginLeft={10}
          color={theme.isDark ? '#FF720D' : theme.colors.secondary}
      ...
      <Flex justifyContent="center">
        ...
        >
          {t(
            'Experience the power of community ownership, global governance, and explore infinite use cases within the PattieSwap ecosystem',
          )}
        </Text>
      </Flex>
      <Flex justifyContent="center" style={{ gap: 14 }}>
        <Link href="https://pattieswap.finance/swap?outputCurrency=0x0eE4024E8d5ae9afFCe26f692028407dD2050B7D&chainId=56">
